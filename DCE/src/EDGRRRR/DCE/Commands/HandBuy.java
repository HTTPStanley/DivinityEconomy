            ...
            if (iStack == null) {
                ...
                if (amountToBuy > availableSpace) {
                    ...
                    if (saleResponse.type == EconomyResponse.ResponseType.SUCCESS && priceResponse.type == EconomyResponse.ResponseType.SUCCESS) {
                        ...
                        String errorMessage;
                        if (saleResponse.type == EconomyResponse.ResponseType.FAILURE) errorMessage = saleResponse.errorMessage;
                        else if (priceResponse.type == EconomyResponse.ResponseType.FAILURE) errorMessage = priceResponse.errorMessage;
