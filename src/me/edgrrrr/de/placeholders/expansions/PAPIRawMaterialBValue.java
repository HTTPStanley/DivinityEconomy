...
public class PAPIRawMaterialBValue extends DivinityExpansion {
    public PAPIRawMaterialBValue(DEPlugin main) {
        super(main, "^raw_material_bvalue_([a-zA-Z]*)_([0-9]*)$");
    }
    ...
    public String getResult(OfflinePlayer player, String value) {
        ...
        if (marketableMaterial != null)
            return String.format("%,.2f", marketableMaterial.getManager().getBuyValue(marketableMaterial.getItemStack(amount), amount).getValue());
