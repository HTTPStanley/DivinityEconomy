...
public enum Setting {
    ...
    IGNORE_ITEM_ERRORS_BOOLEAN(SECTION_MESSAGES.path + ".ignoreItemErrors"),
    ...
    ECONOMY_BALTOP_REFRESH_INTEGER(SECTION_ECONOMY.path + ".baltopRefreshTimer"),
    ...
    MARKET_ENCHANTS_ALLOW_UNSAFE_BOOLEAN(SECTION_MARKET_ENCHANTS.path + ".allowUnsafeEnchants"),
    ...
    COMMAND_ITEMS_ENABLE_BOOLEAN(SECTION_COMMANDS_MARKET.path + ".listitems"),
