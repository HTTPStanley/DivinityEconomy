...
public enum Setting {
	...
	MARKET_MATERIALS_BUY_TAX_FLOAT           ( SECTION_MARKET_MATERIALS.path + ".buyScale"       ),
	MARKET_MATERIALS_SELL_TAX_FLOAT          ( SECTION_MARKET_MATERIALS.path + ".sellScale"      ),
	...
	MARKET_ENCHANTS_BUY_TAX_FLOAT            ( SECTION_MARKET_ENCHANTS.path  + ".buyScale"       ),
	MARKET_ENCHANTS_SELL_TAX_FLOAT           ( SECTION_MARKET_ENCHANTS.path  + ".sellScale"      ),
	...
	COMMAND_SELLALL_ITEM_ENABLE_BOOLEAN      ( SECTION_COMMANDS_MARKET.path  + ".sellall"  ),
