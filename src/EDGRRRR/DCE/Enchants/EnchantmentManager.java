...
public class EnchantmentManager {
    ...
    public MultiValueResponse getSellValue(ItemStack itemStack) {
        ...
        HashMap<Enchantment, Integer> itemStackEnchants = (HashMap<Enchantment, Integer>) itemStack.getEnchantments();
        for (Enchantment enchantment : itemStackEnchants.keySet()) {
            ...
            if (valueResponse.isFailure()) {
                ...
                totalValue += valueResponse.value;
                values.put(enchantID, valueResponse.value);
                quantities.put(enchantID, this.app.getEnchantmentManager().getEnchantAmount(level));
            }
        }

        return new MultiValueResponse(totalValue, values, quantities, responseType, errorMessage);
    }
