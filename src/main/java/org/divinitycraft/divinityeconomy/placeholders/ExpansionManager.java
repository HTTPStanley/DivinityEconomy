...
import org.divinitycraft.divinityeconomy.placeholders.expansions.economy.PAPIBalanceMath;
import org.divinitycraft.divinityeconomy.placeholders.expansions.economy.PAPIPlayerBalance;
import org.divinitycraft.divinityeconomy.placeholders.expansions.generic.PAPIFormatMoney;
import org.divinitycraft.divinityeconomy.placeholders.expansions.market.*;
import org.divinitycraft.divinityeconomy.placeholders.expansions.worlds.*;
...
public class ExpansionManager extends PlaceholderExpansion {
    ...
    public ExpansionManager(DEPlugin main) {
        ...
        this.expansions.add(new PAPIMaterialValue(this.main));
        ...
        this.expansions.add(new PAPIExpValue(this.main));
        this.expansions.add(new PAPIHandEnchantValue(this.main));
        this.expansions.add(new PAPIHandMaterialValue(this.main));
        this.expansions.add(new PAPIHandTotalValue(this.main));
        this.expansions.add(new PAPIEconomyEnabled(this.main));
        this.expansions.add(new PAPIEconomyEnabledWorld(this.main));
        this.expansions.add(new PAPIEconomyEnabledWorlds(this.main));;
        this.expansions.add(new PAPIEconomyDisabledWorlds(this.main));
        this.expansions.add(new PAPIMarketEnabled(this.main));
        this.expansions.add(new PAPIMarketEnabledWorld(this.main));
        this.expansions.add(new PAPIMarketEnabledWorlds(this.main));
        this.expansions.add(new PAPIMarketDisabledWorlds(this.main));
    }
